    ...
    <ul>
        ...
        <li>
            <ul class="menu-children">
                <li><a href="../order?flag=1" title="订单列表" target="mainCont">订单列表</a></li>
            </ul>
        </li>
        <li class="menu-list-title">
            <span>商品管理</span>
        ...
        <li>
            <ul class="menu-children">
                <li><a href="../goods" title="商品列表" target="mainCont">商品列表</a></li>
                <li><a href="../type?flag=0" title="商品分类" target="mainCont">商品分类</a></li>
                <li><a href="recycle_bin.jsp" title="商品评论" target="mainCont">商品评论</a></li>
            </ul>
        </li>
        ...
        <li>
            <ul class="menu-children">
                <li><a href="../user?flag=1" title="会员列表" target="mainCont">会员列表</a></li>
