    ...
    <form onsubmit="return validate()" action="../goods" method="post" enctype="multipart/form-data">
        <table class="list-style">
            <tr>
                ...
                <td><input name="goodsName" id="goodsName" type="text" class="textBox length-long"/>
            ...
            <tr>
                ...
                <td>
                    <input name="price" id="price" type="text" class="textBox length-short"/>
                    <span>元</span>
                </td>
            </tr>
            <%--<tr>
            ...
            <tr>
                ...
                <td>
                    <input name="stock" id="stock" type="text" class="textBox length-short"/>
                    <span>个</span>
                </td>
            </tr>
            <!--<tr>
            ...
            <tr>
                ...
                <td><textarea name="text" class="textarea">这里是水果介绍</textarea></td>
            </tr>
            <tr>
                <td style="text-align:right;"></td>
                <td><input type="submit" value="发布新商品" class="tdBtn" id="addGoods"/></td>
            </tr>
        </table>
    </form>
</div>
...
<script>
    ...
    validate = function () {
        return goodsname() && sele() && price() && stock();
    }
